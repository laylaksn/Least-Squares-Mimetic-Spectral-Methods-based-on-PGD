...
fprintf('L2 errors for the Rank 3 example (i = 3), using the MLS SEM PGD, after three enrichments:')
fprintf('\n');
fprintf('\n'); 
fprintf('N =       ');
fprintf('%8d ', Nvalues);
