...
% figure;
% subplot(3,1,1)
% surf(xdomain,ydomain, approxu)
% subplot(3,1,2)
% surf(xdomain,ydomain, Umesh)
% subplot(3,1,3)
% surf(xdomain,ydomain, Uerror)
%  figure;
% subplot(3,1,1)
% surf(xdomain,ydomain, approxphi)
% subplot(3,1,2)
% surf(xdomain,ydomain, PHImesh)
% subplot(3,1,3)
% surf(xdomain,ydomain, PHIerror)
...
fprintf('L2 errors for the Rank 1 example (i = 1), using the MLS SEM PGD, after one enrichment:')
fprintf('\n');
fprintf('\n'); 
fprintf('N =       ');
fprintf('%8d ', Nvalues);
...
fprintf('\n');
fprintf('Values obtained for expressions (5.1)-(5.4) by the MLS SEM PGD:')
fprintf('\n');
fprintf('\n'); 
fprintf('N = ');
fprintf('%8d ', Nvalues);
